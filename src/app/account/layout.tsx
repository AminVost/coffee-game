...
import { Bell, CreditCard, Hourglass, Home, Scale, ShieldCheck, Trophy, Users } from "lucide-react";
import { SiteHeader } from "@/components/layout/site-header";
import { LogoutButton } from "@/components/layout/logout-button";
import { getSession } from "@/lib/auth";
const links=[["/account","داشبورد",Home],["/account/tournaments","مسابقات من",Trophy],["/account/teams","تیم‌های من",Users],["/account/waitlist","صف انتظار",Hourglass],["/account/payments","پرداخت‌ها",CreditCard],["/account/notifications","اعلان‌ها",Bell],["/account/disputes","اعتراض‌ها",Scale],["/account/security","امنیت",ShieldCheck]] as const;
